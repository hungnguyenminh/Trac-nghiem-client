    ...
    <main className="bg-gray-50 min-h-[100vh] w-full">
          ...
          <div className="flex items-center py-3 px-3 lg:px-5 lg:pl-3">
            {isOpen ? (
              <button
                ...
                onClick={openSidebar}
              >
                <CloseOutlined className="flex justify-center items-center w-6 h-6" />
              </button>
            ) : (
              <button
                ...
                onClick={openSidebar}
              >
                <MenuOutlined className="flex justify-center items-center w-6 h-6" />
              </button>
            )}
            <button
            ...
            >
              <MenuOutlined className="flex justify-center items-center text-xl w-6 h-6" />
            </button>
      ...
      <div className="flex pt-16 h-full">
        <aside
          ...
          className={`flex fixed top-0 left-0 z-20 flex-col flex-shrink-0 bg-white border pt-16 w-64 h-full duration-200 lg:flex transition-width ${
            isOpen ? '' : 'hidden'
                ...
                <li className="" key={index}>
                  <Link href={item.path} onClick={openSidebar}>
                    ...
                    >
                      ...
                      <span
                        className={`ml-3 text-dark-500 text-sm font-light transition-all duration-200 ${
