import {DribbbleOutlined, FacebookFilled, GithubFilled, InstagramFilled, TwitterCircleFilled} from "@ant-design/icons";

export default function Footer() {
    return (
        <footer
            className="card m-6 md:flex md:items-center md:justify-between">
