  ...
  return (
    <div className="m-6">
      <div className="card mb-6 flex justify-between">
        ...
        <div>
          <button className="sm:inline-flex text-white bg-gradient-to-br from-pink-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
            Làm đề
          </button>
        </div>
      </div>
