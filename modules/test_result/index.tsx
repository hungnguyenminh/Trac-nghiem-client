...
export function TestResult() {
    ...
    return (
        <div className={"m-6 p-6 rounded-lg bg-white shadow-lg shadow-gray-200"}>
            ...
            <div className={"grid grid-cols-1 lg:grid-cols-4 gap-y-8 lg:gap-x-8 mb-6"}>
                ...
                <div className={"md:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-8"}>
                    <div className={"rounded-lg border flex flex-col justify-center items-center p-2"}>
                        <h3 className={"text-green-700 mb-2"}><CheckCircleFilled/></h3>
                        <h4 className={"text-green-700 mb-2"}>Số câu đúng</h4>
                        <h3>40</h3>
                    </div>
                    <div className={"rounded-lg border flex flex-col justify-center items-center p-2"}>
                        <h3 className={"text-red-700 mb-2"}><CloseCircleFilled/></h3>
                        <h4 className={"text-red-700 mb-2"}>Số câu sai</h4>
                        <h3>10</h3>
                    </div>
                    <div className={"rounded-lg border flex flex-col justify-center items-center p-2"}>
                        <h3 className={"text-gray-700 mb-2"}><MinusCircleFilled/></h3>
                        <h4 className={"text-gray-700 mb-2"}>Bỏ qua</h4>
                        <h3>0</h3>
                    </div>
                    <div className={"rounded-lg border flex flex-col justify-center items-center p-2"}>
                        <h3 className={"text-gray-700 mb-2"}><FlagFilled/></h3>
            ...
            <div className={"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4"}>
                {listQues.map((item, index) => (
                    ...
                    <div className={"flex items-center"}>
                        <div
                            className={"rounded-[50%] w-8 h-8 flex items-center justify-center bg-blue-200 text-blue-950 font-bold mr-2"}>
                            <span>{index}</span></div>
                        <span>A:</span>
            ...
            <Modal open={isOpen} width={1000} onCancel={() => setIsOpen(false)} title="Câu 1" footer={[]}>
                <div>
                ...
                <div className={"flex items-center mb-4"}>
                    <div
                        className={"w-8 h-8 rounded-[50%] flex items-center justify-center bg-blue-200 text-blue-950 font-bold mr-2"}>
                        <span>1</span>
                    </div>
                    <p>Mark the letter A, B, C, or D on your answer sheet to indicate the correct answer to each of the
                        following questions
                    </p>
                </div>
                <ul className={"ml-6"}>
                ...
                <Collapse
                    items={[{
                        key: '1', label: 'Đáp án chi tiết', children: <>
                            <p>Khi có nhiều tính từ cùng đứng trước 1 danh từ, sắp xếp chúng theo thứ tự: OSASCOMP +
                                N.
                                Trong đó:</p>
                            <ul>
