...
export function SearchResult() {
  ...
  return (
    <div className="grid grid-cols-4 gap-8 relative m-6">
      <div
        className={`flex flex-col lg:static fixed top-0 left-0 z-20 bg-gray-50 lg:bg-white border lg:border-0 pt-16 lg:p-6 w-64 h-full duration-200 lg:col-span-1 lg:rounded-xl lg:shadow-lg lg:shadow-gray-200 transition-width lg:w-full ${
          isOpenFilter ? '' : 'hidden'
        } lg:flex`}
      >
